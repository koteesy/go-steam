...
const file_gcsdk_gcmessages_proto_rawDesc = "" +
	...
	"\n" +
	"service_id\x18\x06 \x01(\rR\tserviceId\"\xbd\x03\n" +
	"\x15CMsgSOMultipleObjects\x12N\n" +
	"\x10objects_modified\x18\x02 \x03(\v2#.CMsgSOMultipleObjects.SingleObjectR\x0fobjectsModified\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x06R\aversion\x12H\n" +
	"\robjects_added\x18\x04 \x03(\v2#.CMsgSOMultipleObjects.SingleObjectR\fobjectsAdded\x12L\n" +
	"\x0fobjects_removed\x18\x05 \x03(\v2#.CMsgSOMultipleObjects.SingleObjectR\x0eobjectsRemoved\x12-\n" +
	"\n" +
	...
	"objectData:\n" +
	"\x80\xa6\x1d\x80\x02\x88\xa6\x1d\x80\b\"\xd2\x02\n" +
	...
	"\fsync_version\x18\x05 \x01(\x06R\vsyncVersion\"H\n" +
	"\x17CMsgSOCacheUnsubscribed\x12-\n" +
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x0e.CMsgSOIDOwnerR\townerSoid\"\xcc\x01\n" +
	...
	"\fsync_version\x18\x06 \x01(\x06R\vsyncVersion\"O\n" +
	...
	"\asuccess\x18\x04 \x01(\bR\asuccess\"\xa5\x01\n" +
	...
	"\x13client_session_need\x18\x03 \x01(\rR\x11clientSessionNeed\x12J\n" +
	"\x0fclient_launcher\x18\x04 \x01(\x0e2\x13.PartnerAccountType:\fPARTNER_NONER\x0eclientLauncher\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x05 \x01(\tR\tsecretKey\x12'\n" +
	"\x0fclient_language\x18\x06 \x01(\rR\x0eclientLanguage\x125\n" +
	"\x06engine\x18\a \x01(\x0e2\x0e.ESourceEngine:\rk_ESE_Source1R\x06engine\x12/\n" +
	...
	"\acountry\x18\x03 \x01(\tR\acountry\"\xc6\x02\n" +
	...
	" estimated_wait_seconds_remaining\x18\x06 \x01(\x05R\x1destimatedWaitSecondsRemaining\"\xd3\x02\n" +
	...
	"\rhave_versions\x18\x04 \x03(\v2,.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersionsR\fhaveVersions\x12*\n" +
	...
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12Q\n" +
	"\x0faccount_details\x18\x02 \x01(\v2(.CGCSystemMsg_GetAccountDetails_ResponseR\x0eaccountDetails\x12\x1f\n" +
	"\vage_seconds\x18\x03 \x01(\rR\n" +
	"ageSeconds\"\x97\x01\n" +
	"\x1cCMsgGCToGCLoadSessionSOCache\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12X\n" +
	"\x17forward_account_details\x18\x02 \x01(\v2 .CMsgGCToGCForwardAccountDetailsR\x15forwardAccountDetails\"&\n" +
	...
	"\x1cCMsgGCToClientRequestDropped\"\xb4\x03\n" +
	...
	"\x16include_partner_events\x18\r \x01(\bR\x14includePartnerEvents\"\xad\x01\n" +
	"(CCommunity_GetClanAnnouncements_Response\x12\x1a\n" +
	"\bmaxchars\x18\x01 \x01(\rR\bmaxchars\x12\x1d\n" +
	"\n" +
	"strip_html\x18\x02 \x01(\bR\tstripHtml\x12F\n" +
	"\rannouncements\x18\x03 \x03(\v2 .CCommunity_ClanAnnouncementInfoR\rannouncements\"\x98\x01\n" +
	...
	"\n" +
	"frame_data\x18\x04 \x01(\fR\tframeData\"\xf3\x03\n" +
	...
	"(CMsgGCToGCMasterSubscribeToCacheResponse\"o\n" +
	"%CMsgGCToGCMasterSubscribeToCacheAsync\x12F\n" +
	"\rsubscribe_msg\x18\x01 \x01(\v2!.CMsgGCToGCMasterSubscribeToCacheR\fsubscribeMsg\"\x9a\x01\n" +
