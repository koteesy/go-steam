...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        internal void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/koteesy/go-steam/v3/steamid\"");
            sb.AppendLine("    \"github.com/koteesy/go-steam/v3/rwu\"");
            sb.AppendLine("    \"github.com/koteesy/go-steam/v3/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
