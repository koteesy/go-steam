...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        internal void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/koteesy/go-steam/v4/steamid\"");
            sb.AppendLine("    \"github.com/koteesy/go-steam/v4/rwu\"");
            sb.AppendLine("    \"github.com/koteesy/go-steam/v4/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
