...
const file_gcsdk_gcmessages_proto_rawDesc = "" +
	...
	"\x02id\x18\x02 \x01(\x04R\x02id\"\x97\x01\n" +
	...
	"\n" +
	"owner_soid\x18\x05 \x01(\v2\x0e.CMsgSOIDOwnerR\townerSoid\"\x86\x02\n" +
	...
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x0e.CMsgSOIDOwnerR\townerSoid\"g\n" +
	"\x1cCMsgSOCacheSubscriptionCheck\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x06R\aversion\x12-\n" +
	"\n" +
	"owner_soid\x18\x03 \x01(\v2\x0e.CMsgSOIDOwnerR\townerSoid\"O\n" +
	...
	"\blocation\x18\x05 \x01(\v2\x1b.CMsgClientWelcome.LocationR\blocation\x12\x1d\n" +
	"\n" +
	...
	" estimated_wait_seconds_remaining\x18\x06 \x01(\x05R\x1destimatedWaitSecondsRemaining\"\xdd\x03\n" +
	"*CWorkshop_PopulateItemDescriptions_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12g\n" +
	"\tlanguages\x18\x02 \x03(\v2I.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlockR\tlanguages\x1a\x8a\x01\n" +
	"\x15SingleItemDescription\x12\x1e\n" +
	"\n" +
	"gameitemid\x18\x01 \x01(\rR\n" +
	"gameitemid\x12)\n" +
	"\x10item_description\x18\x02 \x01(\tR\x0fitemDescription\x12&\n" +
	"\x0fone_per_account\x18\x03 \x01(\bR\ronePerAccount\x1a\xa2\x01\n" +
	...
	"\fgroup_fields\x18\x03 \x03(\tR\vgroupFields\"\xfc\x02\n" +
	"&CGameServers_AggregationQuery_Response\x12E\n" +
	"\x06groups\x18\x01 \x03(\v2-.CGameServers_AggregationQuery_Response.GroupR\x06groups\x1a\x8a\x02\n" +
	"\x05Group\x12!\n" +
	...
	"$CWorkshop_AddSpecialPayment_Response\"\xf8\x02\n" +
	"0CProductInfo_SetRichPresenceLocalization_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12_\n" +
	"\tlanguages\x18\x02 \x03(\v2A.CProductInfo_SetRichPresenceLocalization_Request.LanguageSectionR\tlanguages\x12\x18\n" +
