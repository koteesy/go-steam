...
const file_steammessages_proto_rawDesc = "" +
	"\n" +
	"\x13steammessages.proto\x1a google.golang.org/protobuf/types/descriptorpb\"\x86\x04\n" +
	...
	"\x02ip\x18\x0f \x01(\rR\x02ip\x12N\n" +
	"\n" +
	...
	"\bsteam_id\x18\x01 \x03(\x06R\asteamId\"\xd2\x01\n" +
	"\x12CMsgNotifyWatchdog\x12\x16\n" +
	"\x06source\x18\x01 \x01(\rR\x06source\x12\x1d\n" +
	"\n" +
	"alert_type\x18\x02 \x01(\rR\talertType\x12+\n" +
	"\x11alert_destination\x18\x03 \x01(\rR\x10alertDestination\x12\x1a\n" +
	...
	"\x05infos\x18\x01 \x03(\v2\x10.CIPLocationInfoR\x05infos\"R\n" +
	...
	"\x80\xa6\x1d\x80\x01\x88\xa6\x1d\x80\x04\"\xdf\v\n" +
	...
	"\x10found_friendship\x18\x02 \x01(\bR\x0ffoundFriendship\"\x8a\x02\n" +
	...
	"\tgc_binary\x18\x05 \x01(\tR\bgcBinary\"C\n" +
	"$CMsgGCMsgMasterSetDirectory_Response\x12\x1b\n" +
	"\aeresult\x18\x01 \x01(\x05:\x012R\aeresult\"G\n" +
	...
	"\asteamid\x18\x01 \x01(\x06R\asteamid\"\xb2\x01\n" +
	"$CMsgGCGetPartnerAccountLink_Response\x12\x12\n" +
	"\x04pwid\x18\x01 \x01(\rR\x04pwid\x12\x18\n" +
	"\anexonid\x18\x02 \x01(\rR\anexonid\x12\x1a\n" +
	"\bageclass\x18\x03 \x01(\x05R\bageclass\x12%\n" +
	"\vid_verified\x18\x04 \x01(\b:\x04trueR\n" +
	"idVerified\x12\x19\n" +
	"\bis_adult\x18\x05 \x01(\bR\aisAdult\"\xf5\x02\n" +
	...
	"\fwebapi_param\x18\x05 \x01(\tR\vwebapiParam\"p\n" +
	"\rRoutingMethod\x12\n" +
	"\n" +
	...
	"\aeresult\x18\x01 \x01(\x05:\x012R\aeresult\"\xc1\x02\n" +
	"\x13CMsgGCMsgSetOptions\x125\n" +
	"\aoptions\x18\x01 \x03(\x0e2\x1b.CMsgGCMsgSetOptions.OptionR\aoptions\x12M\n" +
	"\x11client_msg_ranges\x18\x02 \x03(\v2!.CMsgGCMsgSetOptions.MessageRangeR\x0fclientMsgRanges\x1a4\n" +
	...
	"\x11NOTIFY_VAC_ACTION\x10\x03\"\x97\x04\n" +
	...
	"clientAddr\x12C\n" +
	"\fextra_fields\x18\t \x03(\v2 .CMsgGCHUpdateSession.ExtraFieldR\vextraFields\x12\x19\n" +
	"\bowner_id\x18\n" +
	" \x01(\x06R\aownerId\x12(\n" +
	"\x10cm_session_sysid\x18\v \x01(\rR\x0ecmSessionSysid\x122\n" +
	"\x15cm_session_identifier\x18\f \x01(\rR\x13cmSessionIdentifier\x12\x1b\n" +
	"\tdepot_ids\x18\r \x03(\rR\bdepotIds\x1a6\n" +
	"\n" +
	"ExtraField\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
